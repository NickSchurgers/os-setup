...
setup(
    name='ShellScript',
    version='',
    packages=['venv.lib.python3.6.site-packages.pip', 'venv.lib.python3.6.site-packages.pip.req',
              ...
              'venv.lib.python3.6.site-packages.pkg_resources._vendor.packaging', 'venv.lib64.python3.6.distutils',
              'venv.lib64.python3.6.encodings', 'venv.lib64.python3.6.importlib', 'venv.lib64.python3.6.collections',
              'distros'],
    url='',
    license='',
    author='nschurgers',
    author_email='',
    description='', install_requires=['distro', 'colorama']
)
